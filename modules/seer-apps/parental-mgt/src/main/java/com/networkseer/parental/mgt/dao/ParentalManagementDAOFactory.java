...
import com.networkseer.parental.mgt.dao.exception.IllegalTransactionStateException;
import com.networkseer.parental.mgt.dao.exception.TransactionManagementException;
import com.networkseer.parental.mgt.util.ParentalManagementDAOUtil;
 ...
 * </pre>
 */
public class ParentalManagementDAOFactory {
	private static final String jndiPrefix = "java:comp/env/jdbc/";
	private static final String datasourceName = "parental_mgt";
	private static DataSource dataSource;
	private static ThreadLocal<Connection> currentConnection = new ThreadLocal<Connection>();
	private static final Logger log = LoggerFactory.getLogger(ParentalManagementDAOFactory.class);

	public static void init() {
		dataSource = ParentalManagementDAOUtil.lookupDataSource(jndiPrefix +datasourceName);
	}
